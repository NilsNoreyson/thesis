...
\PY{k}{def} \PY{n+nf}{pos\PYZus{}to\PYZus{}r2}\PY{p}{(}\PY{n}{xi}\PY{p}{,}\PY{n}{yi}\PY{p}{,}\PY{n}{grain}\PY{p}{,} \PY{n}{cube\PYZus{}size}\PY{p}{)}\PY{p}{:}
    \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}}
\PY{l+s+sd}{    By passing the xi and yi indices, the grain and one array, the position (r)}
\PY{l+s+sd}{    inside the grain is return}
\PY{l+s+sd}{    \PYZsq{}\PYZsq{}\PYZsq{}}
    ...
    \PY{n}{rx} \PY{o}{=} \PY{o}{\PYZhy{}}\PY{n}{grain}\PY{o}{.}\PY{n}{R}\PY{o}{+}\PY{n}{xi}\PY{o}{*}\PY{n}{cube\PYZus{}size}
    \PY{n}{ry} \PY{o}{=} \PY{o}{\PYZhy{}}\PY{n}{grain}\PY{o}{.}\PY{n}{R}\PY{o}{+}\PY{n}{yi}\PY{o}{*}\PY{n}{cube\PYZus{}size}
    
    \PY{n}{r} \PY{o}{=} \PY{p}{(}\PY{n}{rx}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{o}{+}\PY{n}{ry}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)}\PY{o}{*}\PY{o}{*}\PY{l+m+mf}{0.5}
    \PY{k}{return} \PY{n}{r}

\PY{k}{def} \PY{n+nf}{r\PYZus{}to\PYZus{}pos}\PY{p}{(}\PY{n}{r}\PY{p}{,} \PY{n}{grain}\PY{p}{,} \PY{n}{cube\PYZus{}size}\PY{p}{)}\PY{p}{:}
    \PY{k}{return} \PY{n+nb}{int}\PY{p}{(}\PY{n}{ceil}\PY{p}{(}\PY{p}{(}\PY{n}{r}\PY{o}{+}\PY{n}{grain}\PY{o}{.}\PY{n}{R}\PY{p}{)}\PY{o}{/}\PY{n}{cube\PYZus{}size}\PY{p}{)}\PY{p}{)}
...
\PY{k}{def} \PY{n+nf}{create\PYZus{}numerical\PYZus{}grain\PYZus{}matrix}\PY{p}{(} \PY{n}{grain}\PY{p}{,} \PY{n}{ser}\PY{p}{,}\PY{n}{cube\PYZus{}size}\PY{p}{)}\PY{p}{:}
    ...
    \PY{c+c1}{\PYZsh{}v at arbitrary positions}
    \PY{n}{n\PYZus{}int}\PY{p}{,} \PY{n}{v\PYZus{}int} \PY{o}{=} \PY{n}{get\PYZus{}interpolated\PYZus{}n\PYZus{}v}\PY{p}{(}\PY{n}{ser}\PY{p}{,} \PY{n}{grain}\PY{p}{)}
    \PY{n}{nx} \PY{o}{=} \PY{n}{ny} \PY{o}{=} \PY{n}{r\PYZus{}to\PYZus{}pos}\PY{p}{(}\PY{n}{grain}\PY{o}{.}\PY{n}{R}\PY{p}{,} \PY{n}{grain}\PY{p}{,} \PY{n}{cube\PYZus{}size}\PY{p}{)}
    ...
    \PY{k}{for} \PY{n}{xi} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{d\PYZus{}cond}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{:}
        \PY{k}{for} \PY{n}{yi} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{d\PYZus{}cond}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{:}
            \PY{n}{r} \PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{pos\PYZus{}to\PYZus{}r2}\PY{p}{(}\PY{n}{xi}\PY{p}{,}\PY{n}{yi}\PY{p}{,}\PY{n}{grain}\PY{p}{,} \PY{n}{cube\PYZus{}size}\PY{p}{)}\PY{p}{)}
            \PY{k}{try}\PY{p}{:}
                \PY{c+c1}{\PYZsh{}if r is outside the grain, n\PYZus{}int(r) will fail and got the except part below}
                \PY{c+c1}{\PYZsh{} otherwise the conductivity will be saved in units of nb}
                \PY{n}{condu} \PY{o}{=} \PY{n}{n\PYZus{}int}\PY{p}{(}\PY{n}{r}\PY{p}{)}\PY{o}{/}\PY{n}{grain}\PY{o}{.}\PY{n}{material}\PY{o}{.}\PY{n}{nb}
...
\PY{k}{for} \PY{n}{i}\PY{p}{,} \PY{n}{ser} \PY{o+ow}{in} \PY{n}{calc\PYZus{}dF}\PY{o}{.}\PY{n}{iterrows}\PY{p}{(}\PY{p}{)}\PY{p}{:}
    ...
    \PY{n}{d\PYZus{}v}\PY{p}{,} \PY{n}{d\PYZus{}cond}\PY{p}{,}\PY{n}{d\PYZus{}mask} \PY{o}{=} \PY{n}{create\PYZus{}numerical\PYZus{}grain\PYZus{}matrix}\PY{p}{(} \PY{n}{grain}\PY{p}{,} \PY{n}{ser}\PY{p}{,}\PY{n}{cube\PYZus{}size}\PY{o}{=}\PY{l+m+mf}{1e\PYZhy{}9}\PY{p}{)}
...
\PY{k}{else}\PY{p}{:}
    ...
    \PY{n}{plot\PYZus{}currents}\PY{p}{(}\PY{n}{GrainRadius}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{3-Resistance-sensor_files/3-Resistance-sensor_21_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{calc\PYZus{}dFs}\PY{o}{.}\PY{n}{keys}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{k}{for} \PY{n}{cube\PYZus{}size} \PY{o+ow}{in} \PY{p}{[}\PY{l+m+mf}{10e\PYZhy{}9}\PY{p}{,}\PY{l+m+mf}{5e\PYZhy{}9}\PY{p}{]}\PY{p}{:}
    ...
    \PY{k}{for} \PY{n}{i}\PY{p}{,} \PY{p}{(}\PY{n}{ind}\PY{p}{,}\PY{n}{ser}\PY{p}{)} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{c\PYZus{}dF}\PY{o}{.}\PY{n}{iterrows}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{:}
        ...
        \PY{n}{d\PYZus{}v}\PY{p}{,} \PY{n}{d\PYZus{}cond}\PY{p}{,} \PY{n}{d\PYZus{}mask} \PY{o}{=} \PY{n}{create\PYZus{}numerical\PYZus{}grain\PYZus{}matrix}\PY{p}{(} \PY{n}{grain}\PY{p}{,} \PY{n}{ser}\PY{p}{,}\PY{n}{cube\PYZus{}size}\PY{o}{=}\PY{n}{cube\PYZus{}size}\PY{p}{)}
        \PY{n}{d\PYZus{}v} \PY{o}{=} \PY{n}{initaliz\PYZus{}d\PYZus{}v}\PY{p}{(}\PY{n}{d\PYZus{}v}\PY{p}{,} \PY{n}{d\PYZus{}mask}\PY{p}{,} \PY{l+m+mi}{1000}\PY{p}{)}
    ...
    \PY{n}{calc\PYZus{}dFs}\PY{p}{[}\PY{n}{cube\PYZus{}size}\PY{p}{]} \PY{o}{=} \PY{n}{c\PYZus{}dF}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{fig}\PY{p}{,} \PY{n}{axes} \PY{o}{=} \PY{n}{subplots}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{figsize} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{16}\PY{p}{,}\PY{l+m+mi}{9}\PY{p}{)}\PY{p}{,} \PY{n}{sharey}\PY{o}{=}\PY{k+kc}{True}\PY{p}{,} \PY{n}{sharex}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
...
\PY{k}{for} \PY{n}{ax\PYZus{}i}\PY{p}{,}\PY{p}{(}\PY{n}{size\PYZus{}n}\PY{p}{,}\PY{n}{calc\PYZus{}dF\PYZus{}n}\PY{p}{)} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{calc\PYZus{}dFs}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{:}
    ...
    \PY{k}{for} \PY{n}{ax\PYZus{}i}\PY{p}{,} \PY{p}{(}\PY{n}{R}\PY{p}{,}\PY{n}{calc\PYZus{}dF\PYZus{}grainsize}\PY{p}{)} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{calc\PYZus{}dF\PYZus{}n}\PY{o}{.}\PY{n}{groupby}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{R}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}\PY{p}{:}
        ...
        \PY{n}{axe}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{v}\PY{p}{,} \PY{n}{res}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{o\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{label} \PY{o}{=} \PY{l+s+sa}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Grainsize = }\PY{l+s+s1}{\PYZob{}}\PY{l+s+s1}{R*1e9:.0f\PYZcb{}nm}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{linewidth}\PY{o}{=}\PY{l+m+mi}{5}\PY{p}{)}
...
\PY{n}{size\PYZus{}n} \PY{o}{=} \PY{l+m+mi}{100}
\PY{n}{calc\PYZus{}dF\PYZus{}n} \PY{o}{=} \PY{n}{calc\PYZus{}dFs}\PY{p}{[}\PY{n}{size\PYZus{}n}\PY{p}{]}
