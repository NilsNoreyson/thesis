...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2-Grain-SMOX_files/2-Grain-SMOX_32_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\PY{k}{def} \PY{n+nf}{create\PYZus{}grain}\PY{p}{(}\PY{n}{grainsize}\PY{p}{,} \PY{n}{T\PYZus{}C}\PY{o}{=}\PY{l+m+mi}{300}\PY{p}{,} \PY{n}{ND}\PY{o}{=}\PY{l+m+mf}{9e21}\PY{p}{)}\PY{p}{:}
    \PY{n}{T\PYZus{}C} \PY{o}{=} \PY{l+m+mi}{300}
    \PY{n}{ND} \PY{o}{=} \PY{l+m+mf}{9e21}
    \PY{n}{mass\PYZus{}e\PYZus{}eff\PYZus{}factor} \PY{o}{=}\PY{l+m+mf}{0.3}
    ...
    \PY{c+c1}{\PYZsh{}print(f\PYZsq{}For SnO2 at \PYZob{}T\PYZus{}C\PYZcb{}°C with a defect concentration of \PYZob{}ND\PYZcb{} 1/m³, the value of EDCF\PYZus{}eV is \PYZob{}EDCF\PYZus{}eV\PYZcb{} eV\PYZsq{})    }
    \PY{n}{material} \PY{o}{=} \PY{n}{Material}\PY{p}{(}\PY{n}{T\PYZus{}C}\PY{p}{,}\PY{n}{DIFF\PYZus{}EF\PYZus{}EC\PYZus{}evolt}\PY{o}{=}\PY{n}{EDCF\PYZus{}eV}\PY{p}{)}
...
\PY{k}{for} \PY{n}{grainsize} \PY{o+ow}{in} \PY{p}{[}\PY{l+m+mf}{50e\PYZhy{}9}\PY{p}{,} \PY{l+m+mf}{100e\PYZhy{}9}\PY{p}{,} \PY{l+m+mf}{200e\PYZhy{}9}\PY{p}{,} \PY{l+m+mf}{400e\PYZhy{}9}\PY{p}{]}\PY{p}{:}
    \PY{n+nb}{print}\PY{p}{(}\PY{n}{ND}\PY{p}{,} \PY{n}{T\PYZus{}C}\PY{p}{,} \PY{n}{grainsize}\PY{p}{)}
...
\end{tcolorbox}
    ...
    Screen some more Change some more paramters \ldots{}

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{for} \PY{n}{ND} \PY{o+ow}{in} \PY{p}{[}\PY{l+m+mf}{1e20}\PY{p}{,} \PY{l+m+mf}{1e21}\PY{p}{,} \PY{l+m+mf}{1e22}\PY{p}{,} \PY{l+m+mf}{1e23}\PY{p}{]}\PY{p}{:}
    \PY{k}{for} \PY{n}{T\PYZus{}C} \PY{o+ow}{in} \PY{p}{[}\PY{l+m+mi}{50}\PY{p}{,} \PY{l+m+mi}{100}\PY{p}{,} \PY{l+m+mi}{200}\PY{p}{,} \PY{l+m+mi}{300}\PY{p}{,} \PY{l+m+mi}{400}\PY{p}{]}\PY{p}{:}
        \PY{k}{for} \PY{n}{grainsize} \PY{o+ow}{in} \PY{p}{[}\PY{l+m+mf}{50e\PYZhy{}9}\PY{p}{,} \PY{l+m+mf}{100e\PYZhy{}9}\PY{p}{,} \PY{l+m+mf}{200e\PYZhy{}9}\PY{p}{,} \PY{l+m+mf}{400e\PYZhy{}9}\PY{p}{]}\PY{p}{:}
            \PY{k}{try}\PY{p}{:}
                ...
                \PY{n}{dF\PYZus{}calc\PYZus{}temp} \PY{o}{=} \PY{n}{calcualte\PYZus{}conduction\PYZus{}band}\PY{p}{(}\PY{n}{grain}\PY{p}{)}
                \PY{n}{dF\PYZus{}calc} \PY{o}{=} \PY{n}{dF\PYZus{}calc}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{dF\PYZus{}calc\PYZus{}temp}\PY{p}{)}
                \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{OOOOOOKKKKKKKKKKKKKKKKKKKK}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                \PY{n+nb}{print}\PY{p}{(}\PY{n}{ND}\PY{p}{,} \PY{n}{T\PYZus{}C}\PY{p}{,} \PY{n}{grainsize}\PY{p}{)}
                \PY{n+nb}{print}\PY{p}{(}\PY{p}{)}
            \PY{k}{except} \PY{n+ne}{Exception} \PY{k}{as} \PY{n}{e}\PY{p}{:}
                \PY{n+nb}{print}\PY{p}{(}\PY{n}{e}\PY{p}{)}
                \PY{n+nb}{print}\PY{p}{(}\PY{n}{ND}\PY{p}{,} \PY{n}{TC}\PY{p}{,} \PY{n}{grainsize}\PY{p}{)}
                \PY{n+nb}{print}\PY{p}{(}\PY{p}{)}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2-Grain-SMOX_files/2-Grain-SMOX_56_1.png}
    \end{center}
    { \hspace*{\fill} \\}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2-Grain-SMOX_files/2-Grain-SMOX_56_3.png}
    \end{center}
    { \hspace*{\fill} \\}
