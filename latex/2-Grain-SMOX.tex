...
EDCF\_eV is 0.31635452989085217 eV
    \end{Verbatim}
...
\PY{k}{class} \PY{n+nc}{Grain}\PY{p}{:}
    ...
    \PY{k}{def} \PY{n+nf}{solve\PYZus{}with\PYZus{}values}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{,}\PY{n}{E\PYZus{}init}\PY{p}{,} \PY{n}{E\PYZus{}dot\PYZus{}init}\PY{p}{)}\PY{p}{:}
        ...
        \PY{c+c1}{\PYZsh{}data = solve\PYZus{}ivp(self.deriv\PYZus{}E\PYZus{}E\PYZus{}dot,(r\PYZus{}LD[\PYZhy{}1],r\PYZus{}LD[0]),  [E\PYZus{}init\PYZus{}kT,E\PYZus{}dot\PYZus{}init\PYZus{}kt], t\PYZus{}eval=r\PYZus{}LD[::\PYZhy{}1], events=hit\PYZus{}ground, method = \PYZsq{}Radau\PYZsq{},max\PYZus{}step=max(r\PYZus{}LD/1000))}
        \PY{c+c1}{\PYZsh{}see the docstring why I chose the metohd BDF}
        \PY{n}{data} \PY{o}{=} \PY{n}{solve\PYZus{}ivp}\PY{p}{(}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{deriv\PYZus{}E\PYZus{}E\PYZus{}dot}\PY{p}{,}\PY{p}{(}\PY{n}{r\PYZus{}LD}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}\PY{n}{r\PYZus{}LD}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{,}  \PY{p}{[}\PY{n}{E\PYZus{}init\PYZus{}kT}\PY{p}{,}\PY{n}{E\PYZus{}dot\PYZus{}init\PYZus{}kt}\PY{p}{]}\PY{p}{,} \PY{n}{t\PYZus{}eval}\PY{o}{=}\PY{n}{r\PYZus{}LD}\PY{p}{[}\PY{p}{:}\PY{p}{:}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{events}\PY{o}{=}\PY{n}{hit\PYZus{}ground}\PY{p}{,} \PY{n}{method} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{BDF}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        ...
        \PY{c+c1}{\PYZsh{}sinde we stop the evaluation earlier, when v\PYZus{}dot = 0, the missing elements are fileed up}
...
\end{tcolorbox}
    ...
    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{765}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k+kn}{from} \PY{n+nn}{scipy}\PY{n+nn}{.}\PY{n+nn}{optimize} \PY{k+kn}{import} \PY{n}{minimize\PYZus{}scalar}\PY{p}{,}\PY{n}{bracket}
...
\PY{k}{def} \PY{n+nf}{min\PYZus{}vdot}\PY{p}{(}\PY{n}{vdot\PYZus{}init}\PY{p}{,} \PY{n}{grain}\PY{p}{,} \PY{n}{vinit}\PY{p}{,} \PY{n}{debug} \PY{o}{=} \PY{k+kc}{False}\PY{p}{)}\PY{p}{:}
    ...
    \PY{c+c1}{\PYZsh{}kick this out, we dont need it anymore}
    
    \PY{c+c1}{\PYZsh{}r = np.concatenate([[0.01],r], axis=0)}
    \PY{c+c1}{\PYZsh{}\PYZsh{}If the slope is zero, the slope should stay zero until the center}
    \PY{c+c1}{\PYZsh{}vdot = np.concatenate([[0],vdot], axis=0)}
    
    \PY{c+c1}{\PYZsh{}\PYZsh{}and since the slope is zero, also the value should not change anymore}
    \PY{c+c1}{\PYZsh{}v = np.concatenate([[v[0]],v], axis=0)}
    ...
    \PY{c+c1}{\PYZsh{}print(res,vdot\PYZus{}init )}
    \PY{c+c1}{\PYZsh{}return the \PYZsq{}error\PYZsq{} to be minimized}
    \PY{n}{percent\PYZus{}error} \PY{o}{=} \PY{n}{res}\PY{o}{/}\PY{n}{vdot\PYZus{}init}\PY{o}{*}\PY{l+m+mi}{100}
    \PY{k}{if} \PY{n}{debug}\PY{p}{:}
        \PY{n+nb}{print}\PY{p}{(}\PY{n}{vdot\PYZus{}init}\PY{p}{,} \PY{n}{dV}\PY{p}{,} \PY{n}{vinit}\PY{p}{,} \PY{n}{res}\PY{p}{,} \PY{n+nb}{round}\PY{p}{(}\PY{n}{percent\PYZus{}error}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}
    \PY{c+c1}{\PYZsh{}print(percent\PYZus{}error)}
    \PY{k}{return} \PY{n}{res}

\PY{k}{def} \PY{n+nf}{find\PYZus{}best\PYZus{}v\PYZus{}dot\PYZus{}init}\PY{p}{(}\PY{n}{E\PYZus{}init\PYZus{}kT}\PY{p}{,} \PY{n}{grain}\PY{p}{,}\PY{n}{debug} \PY{o}{=} \PY{k+kc}{False}\PY{p}{,} \PY{n}{bounds} \PY{o}{=} \PY{k+kc}{None}\PY{p}{)}\PY{p}{:}
    \PY{c+c1}{\PYZsh{}find for a given inital value E\PYZus{}init\PYZus{}kT, the correspoding E\PYZus{}init\PYZus{}dot\PYZus{}kT}
    \PY{c+c1}{\PYZsh{}if E\PYZus{}init\PYZus{}kT\PYZgt{}0:}
    \PY{c+c1}{\PYZsh{}    bounds = sorted([E\PYZus{}init\PYZus{}kT/50,0])}
    \PY{c+c1}{\PYZsh{}else:}
    \PY{c+c1}{\PYZsh{}    bounds = sorted([E\PYZus{}init\PYZus{}kT*10,E\PYZus{}init\PYZus{}kT])}
    \PY{c+c1}{\PYZsh{}res = minimize\PYZus{}scalar(min\PYZus{}vdot,  bounds=bounds, tol=abs(E\PYZus{}init\PYZus{}kT/10000), method=\PYZsq{}Bounded\PYZsq{}, args=(grain, E\PYZus{}init\PYZus{}kT))}
    \PY{c+c1}{\PYZsh{}min\PYZus{}vdot return the relative error in percent to the optimal sollution, we will stop at 1\PYZpc{} error}
    \PY{c+c1}{\PYZsh{}print(\PYZsq{}bounds\PYZsq{}, bounds)}
    \PY{c+c1}{\PYZsh{}res = scipy.optimize.basinhopping(min\PYZus{}vdot,minimizer\PYZus{}kwargs=\PYZob{}\PYZsq{}args\PYZsq{}:(grain, E\PYZus{}init\PYZus{}kT)\PYZcb{},x0 = E\PYZus{}init\PYZus{}kT)}
    \PY{c+c1}{\PYZsh{}res = minimize\PYZus{}scalar(min\PYZus{}vdot, bounds=bounds, method=\PYZsq{}Golden\PYZsq{},args=(grain, E\PYZus{}init\PYZus{}kT), xtol=0.01)}
    \PY{k}{if} \PY{n}{bounds}\PY{p}{:}
        \PY{n}{res} \PY{o}{=} \PY{n}{minimize\PYZus{}scalar}\PY{p}{(}\PY{n}{min\PYZus{}vdot}\PY{p}{,}\PY{n}{args}\PY{o}{=}\PY{p}{(}\PY{n}{grain}\PY{p}{,} \PY{n}{E\PYZus{}init\PYZus{}kT}\PY{p}{,} \PY{n}{debug}\PY{p}{)}\PY{p}{,} \PY{n}{method} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Bounded}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{bounds} \PY{o}{=} \PY{n}{bounds}\PY{p}{)}
    \PY{k}{else}\PY{p}{:}
    ...
    \PY{c+c1}{\PYZsh{}res = bracket(min\PYZus{}vdot,xa=bounds[1], xb=bounds[0],args=(grain, E\PYZus{}init\PYZus{}kT, debug))}
    \PY{k}{return} \PY{n}{res}
\end{Verbatim}
\end{tcolorbox}
...
\section{Example}\label{example}}
    ...
    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{822}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{}material = Material(300,4.5e21)}
\PY{c+c1}{\PYZsh{}grain = Grain(50e\PYZhy{}9,material, rPoints=1000)}


\PY{n}{ser} \PY{o}{=} \PY{n}{calc\PYZus{}dF\PYZus{}all}\PY{o}{.}\PY{n}{dropna}\PY{p}{(}\PY{n}{subset}\PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{E\PYZus{}dot\PYZus{}init\PYZus{}kT\PYZus{}estimation}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{iloc}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}

\PY{n}{grain} \PY{o}{=} \PY{n}{create\PYZus{}grain\PYZus{}from\PYZus{}data}\PY{p}{(}\PY{n}{ser}\PY{p}{)}


\PY{n}{fig}\PY{p}{,} \PY{n}{axes} \PY{o}{=} \PY{n}{subplots}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{,}\PY{n}{figsize} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{16}\PY{p}{,}\PY{l+m+mi}{9}\PY{p}{)}\PY{p}{)}
...
\PY{n}{E\PYZus{}init\PYZus{}kT} \PY{o}{=} \PY{o}{\PYZhy{}}\PY{l+m+mi}{6}
\PY{n}{E\PYZus{}init\PYZus{}kT} \PY{o}{=} \PY{n}{ser}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Einit\PYZus{}kT}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
\PY{n}{E\PYZus{}init} \PY{o}{=} \PY{n}{grain}\PY{o}{.}\PY{n}{material}\PY{o}{.}\PY{n}{kT\PYZus{}to\PYZus{}J}\PY{p}{(}\PY{n}{E\PYZus{}init\PYZus{}kT}\PY{p}{)}
\PY{n}{estim} \PY{o}{=} \PY{n}{ser}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{E\PYZus{}dot\PYZus{}init\PYZus{}kT\PYZus{}estimation}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
\PY{n}{bounds} \PY{o}{=} \PY{n+nb}{sorted}\PY{p}{(}\PY{p}{(}\PY{n}{estim}\PY{o}{*}\PY{l+m+mf}{0.9}\PY{p}{,} \PY{n}{estim}\PY{o}{*}\PY{l+m+mf}{1.1}\PY{p}{)}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{n}{bounds}\PY{p}{,} \PY{n}{estim}\PY{p}{)}
\PY{n}{res} \PY{o}{=} \PY{n}{find\PYZus{}best\PYZus{}v\PYZus{}dot\PYZus{}init}\PY{p}{(}\PY{n}{E\PYZus{}init\PYZus{}kT}\PY{p}{,} \PY{n}{grain}\PY{p}{,}\PY{n}{debug}\PY{o}{=}\PY{k+kc}{True}\PY{p}{,} \PY{n}{bounds}\PY{o}{=}\PY{n}{bounds}\PY{p}{)}
\PY{c+c1}{\PYZsh{}E\PYZus{}dot\PYZus{}init\PYZus{}kT = \PYZhy{}3.532822819868218*5\PYZsh{}*16.9345}
\PY{n+nb}{print}\PY{p}{(}\PY{n}{res}\PY{p}{)}
\PY{n}{E\PYZus{}dot\PYZus{}init\PYZus{}kT} \PY{o}{=} \PY{n}{res}\PY{o}{.}\PY{n}{x}
\PY{n+nb}{print}\PY{p}{(}\PY{n}{E\PYZus{}dot\PYZus{}init\PYZus{}kT}\PY{p}{)}
...
\PY{n+nb}{print}\PY{p}{(}\PY{n}{min\PYZus{}vdot}\PY{p}{(}\PY{n}{E\PYZus{}dot\PYZus{}init\PYZus{}kT}\PY{p}{,} \PY{n}{grain}\PY{p}{,} \PY{n}{E\PYZus{}init\PYZus{}kT}\PY{p}{)}\PY{p}{)}
...
\PY{n}{r}\PY{p}{,}\PY{n}{v}\PY{p}{,} \PY{n}{v\PYZus{}dot}\PY{p}{,} \PY{n}{data} \PY{o}{=} \PY{n}{grain}\PY{o}{.}\PY{n}{solve\PYZus{}with\PYZus{}values}\PY{p}{(}\PY{n}{E\PYZus{}init}\PY{p}{,} \PY{n}{estim}\PY{p}{)}
\PY{n}{axe}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{r}\PY{p}{,}\PY{n}{v}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZhy{}*}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+sa}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZob{}estim:.2f\PYZcb{}}\PY{l+s+s1}{ estim}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\PY{n}{g} \PY{o}{=} \PY{n}{calc\PYZus{}dF\PYZus{}all}\PY{o}{.}\PY{n}{groupby}\PY{p}{(}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ND}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{R}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{get\PYZus{}group}\PY{p}{(}\PY{p}{(}\PY{n}{ND}\PY{p}{,} \PY{n}{R}\PY{p}{)}\PY{p}{)}
...
\PY{n}{axe}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{g\PYZus{}good}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Einit\PYZus{}kT}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{g\PYZus{}good}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{E\PYZus{}dor\PYZus{}init\PYZus{}kT}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{o\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{n}{axe}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{g\PYZus{}bad}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Einit\PYZus{}kT}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{g\PYZus{}bad}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{E\PYZus{}dor\PYZus{}init\PYZus{}kT}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{*\PYZhy{}\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{c+c1}{\PYZsh{}axe.set\PYZus{}yscale(\PYZsq{}symlog\PYZsq{})}

\PY{n}{x} \PY{o}{=} \PY{n}{g\PYZus{}good}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Einit\PYZus{}kT}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
\PY{n}{y} \PY{o}{=} \PY{n}{g\PYZus{}good}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{E\PYZus{}dor\PYZus{}init\PYZus{}kT}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
\PY{n}{g\PYZus{}fit\PYZus{}params} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{polyfit}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{)}
\PY{n}{fit\PYZus{}func} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{poly1d}\PY{p}{(}\PY{n}{g\PYZus{}fit\PYZus{}params}\PY{p}{)}
\PY{n}{g\PYZus{}bad\PYZus{}correct\PYZus{}y}  \PY{o}{=} \PY{n}{fit\PYZus{}func}\PY{p}{(}\PY{n}{g\PYZus{}bad}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Einit\PYZus{}kT}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
\PY{n}{axe}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{g\PYZus{}bad}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Einit\PYZus{}kT}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{g\PYZus{}bad\PYZus{}correct\PYZus{}y}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{*}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{n}{axe}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{g\PYZus{}bad}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Einit\PYZus{}kT}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{g\PYZus{}bad}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{E\PYZus{}dor\PYZus{}init\PYZus{}kT}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{o}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{c+c1}{\PYZsh{}calc\PYZus{}dF\PYZus{}all.loc[g\PYZus{}bad.index, \PYZsq{}E\PYZus{}dot\PYZus{}init\PYZus{}kT\PYZus{}estimation\PYZsq{}] = g\PYZus{}bad\PYZus{}correct\PYZus{}y}
\PY{n}{axe}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{p}{[}\PY{n}{ser}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Einit\PYZus{}kT}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{n}{res}\PY{o}{.}\PY{n}{x}\PY{p}{]}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{sk}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    \begin{Verbatim}[commandchars=\\\{\}]
[-44.38907932659787, -36.3183376308528] -40.35370847872534
-41.30633031324422 302.13363055459274 -7.0 343.43996086783693 -831.45
-39.40108664420646 -72.91172499958748 -7.0 33.51063835538102 -85.05
-38.22358129989057 -133.46105303828375 -7.0 95.23747173839318 -249.16
-39.18799149811457 -85.75360457153246 -7.0 46.56561307341789 -118.83
-40.12882496892833 233.69682087378717 -7.0 273.8256458427155 -682.37
-39.67905794933431 -51.661664139179265 -7.0 11.982606189844958 -30.2
-39.850853663800486 217.79648537336854 -7.0 257.64733903716905 -646.53
-39.572882358672636 -61.307568012060905 -7.0 21.73468565338827 -54.92
-39.744678073138815 743.0728596993908 -7.0 782.8175377725297 -1969.62
-39.63850248247714 -55.58020457208415 -7.0 15.941702089607006 -40.22
-39.70412260628165 -48.76758603669991 -7.0 9.06346343041826 -22.83
-39.719613416191464 -46.72923054118849 -7.0 7.009617124997028 -17.65
-39.729187263228994 -44.97427061867904 -7.0 5.245083355450049 -13.2
-39.735104226101285 -43.45298551664229 -7.0 3.7178812905410084 -9.36
-39.73876111026653 -41.967745454725666 -7.0 2.2289843444591355 -5.61
-39.74102118897357 1806.571476529677 -7.0 1846.3124977186505 -4645.86
-39.73736430480833 -42.68037389634958 -7.0 2.943009591541248 -7.41
-39.73962438351537 -41.349110320900394 -7.0 1.609485937385024 -4.05
-39.74015791572473 -40.16753917319686 -7.0 0.42738125747212763 -1.08
-39.74048765676421 2510.0837152598288 -7.0 2549.824202916593 -6416.19
-39.73995412455485 -40.937006971267515 -7.0 1.1970528467126655 -3.01
-39.74028386559433 3466.0921896352834 -7.0 3505.8324735008778 -8821.86
-39.74008007442444 -40.57420843482378 -7.0 0.8341283603993404 -2.1
-39.74020602429404 1126.001356907539 -7.0 1165.7415629318332 -2933.41
-39.74012818299375 -40.41676615850405 -7.0 0.6766379755103031 -1.7
-39.74017629156305 157.14852428368027 -7.0 196.88870057524332 -495.44
-39.74014655883207 -40.28671064879005 -7.0 0.5465640899579753 -1.38
-39.740164934670396 -40.07292623821971 -7.0 0.33276130354931155 -0.84
-39.740169272617386 -39.95815150682751 -7.0 0.21798223421012608 -0.55
     fun: 0.21798223421012608
 message: 'Solution found.'
    nfev: 29
  status: 0
 success: True
       x: -39.740169272617386
-39.740169272617386
0.21798223421012608
    \end{Verbatim}

            \begin{tcolorbox}[breakable, size=fbox, boxrule=.5pt, pad at break*=1mm, opacityfill=0]
\prompt{Out}{outcolor}{822}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
[<matplotlib.lines.Line2D at 0x7f4ca6b4fd30>]
\end{Verbatim}
\end{tcolorbox}
        
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2-Grain-SMOX_files/2-Grain-SMOX_37_2.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\PY{n}{g} \PY{o}{=} \PY{n}{create\PYZus{}grain}\PY{p}{(}\PY{l+m+mf}{50e\PYZhy{}9}\PY{p}{,} \PY{n}{T\PYZus{}C}\PY{o}{=}\PY{l+m+mi}{300}\PY{p}{,} \PY{n}{ND}\PY{o}{=}\PY{l+m+mf}{9e21}\PY{o}{*}\PY{l+m+mi}{4}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{n}{g}\PY{o}{.}\PY{n}{R}\PY{o}{/}\PY{n}{g}\PY{o}{.}\PY{n}{material}\PY{o}{.}\PY{n}{LD}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2-Grain-SMOX_files/2-Grain-SMOX_40_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2-Grain-SMOX_files/2-Grain-SMOX_43_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\PY{k}{def} \PY{n+nf}{min\PYZus{}vdot}\PY{p}{(}\PY{n}{vdot\PYZus{}init}\PY{p}{,} \PY{n}{grain}\PY{p}{,} \PY{n}{vinit}\PY{p}{)}\PY{p}{:}
    ...
    \PY{c+c1}{\PYZsh{}return the \PYZsq{}error\PYZsq{} to be minimized}
    \PY{n}{percent\PYZus{}error} \PY{o}{=} \PY{n+nb}{abs}\PY{p}{(}\PY{n}{res}\PY{o}{/}\PY{n}{vdot\PYZus{}init}\PY{o}{*}\PY{l+m+mi}{100}\PY{p}{)}
    
    \PY{n+nb}{print}\PY{p}{(}\PY{n}{vdot\PYZus{}init}\PY{p}{,} \PY{n}{dV}\PY{p}{,} \PY{n}{vinit}\PY{p}{,} \PY{n}{res}\PY{p}{,} \PY{n+nb}{round}\PY{p}{(}\PY{n}{percent\PYZus{}error}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}
    
    \PY{k}{return} \PY{n}{percent\PYZus{}error}

\PY{k}{def} \PY{n+nf}{find\PYZus{}best\PYZus{}v\PYZus{}dot\PYZus{}init}\PY{p}{(}\PY{n}{E\PYZus{}init\PYZus{}kT}\PY{p}{,} \PY{n}{grain}\PY{p}{)}\PY{p}{:}
    \PY{c+c1}{\PYZsh{}find for a given inital value E\PYZus{}init\PYZus{}kT, the correspoding E\PYZus{}init\PYZus{}dot\PYZus{}kT}
    \PY{n}{bounds} \PY{o}{=} \PY{n+nb}{sorted}\PY{p}{(}\PY{p}{[}\PY{n}{E\PYZus{}init\PYZus{}kT}\PY{o}{*}\PY{l+m+mi}{100}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
    \PY{c+c1}{\PYZsh{}res = minimize\PYZus{}scalar(min\PYZus{}vdot,  bounds=bounds, tol=abs(E\PYZus{}init\PYZus{}kT/10000), method=\PYZsq{}Bounded\PYZsq{}, args=(grain, E\PYZus{}init\PYZus{}kT))}
    \PY{c+c1}{\PYZsh{}min\PYZus{}vdot return the relative error in percent to the optimal sollution, we will stop at 1\PYZpc{} error}
    
    \PY{n}{res} \PY{o}{=} \PY{n}{minimize\PYZus{}scalar}\PY{p}{(}\PY{n}{min\PYZus{}vdot}\PY{p}{,} \PY{n}{bounds}\PY{o}{=}\PY{n}{bounds}\PY{p}{,} \PY{n}{method}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Bounded}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{args}\PY{o}{=}\PY{p}{(}\PY{n}{grain}\PY{p}{,} \PY{n}{E\PYZus{}init\PYZus{}kT}\PY{p}{)}\PY{p}{,} \PY{n}{tol}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
    \PY{k}{return} \PY{n}{res}
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
<ipython-input-515-3b454f08259c>:33: RuntimeWarning: divide by zero encountered
in double\_scalars
  percent\_error = res/vdot\_init*100
    \end{Verbatim}

    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2-Grain-SMOX_files/2-Grain-SMOX_47_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\texttt{Dataframe}, where all our results will be stored.
    ...
    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{908}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k+kn}{import} \PY{n+nn}{pandas} \PY{k}{as} \PY{n+nn}{pd}
...
\end{tcolorbox}
    ...
    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{684}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{calcualte\PYZus{}conduction\PYZus{}band}\PY{p}{(}\PY{n}{grain}\PY{p}{)}\PY{p}{:}
    ...
    \PY{c+c1}{\PYZsh{}for vinit in [\PYZhy{}8,\PYZhy{}4,\PYZhy{}2,\PYZhy{}1,0,1,2,4,8]:}
    \PY{k}{for} \PY{n}{vinit} \PY{o+ow}{in} \PY{n+nb}{list}\PY{p}{(}\PY{n+nb}{list}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mi}{10}\PY{p}{,}\PY{l+m+mi}{11}\PY{p}{)}\PY{p}{)}\PY{p}{)}\PY{p}{:}
    \PY{c+c1}{\PYZsh{}for vinit in [\PYZhy{}8,8]:}
        \PY{c+c1}{\PYZsh{}print(f\PYZsq{}Solving for \PYZob{}vinit\PYZcb{}\PYZsq{})}
        ...
        \PY{c+c1}{\PYZsh{}dont need it anymore}
        \PY{c+c1}{\PYZsh{}r = np.concatenate([[0.01],r], axis=0)}
        \PY{c+c1}{\PYZsh{}v = np.concatenate([[v[0]],v], axis=0)}
        \PY{c+c1}{\PYZsh{}vdot = np.concatenate([[0],vdot], axis=0)}
        ...
        \PY{c+c1}{\PYZsh{}surf\PYZus{}charges = np.trapz((np.array(4*pi*ser\PYZus{}temp[\PYZsq{}n\PYZsq{}]))*(ser\PYZus{}temp[\PYZsq{}r\PYZsq{}]*grain.material.LD)**2, ser\PYZus{}temp[\PYZsq{}r\PYZsq{}]*grain.material.LD)}
        \PY{c+c1}{\PYZsh{}all\PYZus{}charges = 4/3*pi*(ser[\PYZsq{}R\PYZsq{}]**3)*grain.material.nb}
        \PY{c+c1}{\PYZsh{}ser\PYZus{}temp[\PYZsq{}trapped\PYZus{}charges\PYZsq{}] = surf\PYZus{}charges}
        \PY{c+c1}{\PYZsh{}ser\PYZus{}temp[\PYZsq{}all\PYZus{}\PYZus{}charges\PYZsq{}] = all\PYZus{}charges}
...
\PY{c+c1}{\PYZsh{} create a list of the tuples with (T\PYZus{}C, ND, Grainradius) to be alter caluculated in parallel}
\PY{n}{params} \PY{o}{=} \PY{p}{[}\PY{p}{]}
\PY{n}{T\PYZus{}C} \PY{o}{=} \PY{l+m+mi}{300}
\PY{n}{ND\PYZus{}ref} \PY{o}{=} \PY{l+m+mf}{9e21}
\PY{k}{for} \PY{n}{ND} \PY{o+ow}{in} \PY{p}{[}\PY{n}{ND\PYZus{}ref}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{,}\PY{n}{ND\PYZus{}ref}\PY{p}{,} \PY{n}{ND\PYZus{}ref}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{:}
    \PY{k}{for} \PY{n}{grainsize} \PY{o+ow}{in} \PY{p}{[} \PY{l+m+mf}{50e\PYZhy{}9}\PY{p}{,} \PY{l+m+mf}{100e\PYZhy{}9}\PY{p}{,} \PY{l+m+mf}{200e\PYZhy{}9}\PY{p}{,} \PY{l+m+mf}{400e\PYZhy{}9}\PY{p}{]}\PY{p}{:}
        \PY{n}{params}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{p}{(}\PY{n}{T\PYZus{}C}\PY{p}{,} \PY{n}{ND}\PY{p}{,} \PY{n}{grainsize}\PY{p}{)}\PY{p}{)}
...
\PY{c+c1}{\PYZsh{}All solution is are returned in a list, which needs then to be combined again (see next cell)}
...
\PY{k}{with} \PY{n}{Pool}\PY{p}{(}\PY{l+m+mi}{8}\PY{p}{)} \PY{k}{as} \PY{n}{p}\PY{p}{:}
    \PY{n}{all\PYZus{}res\PYZus{}list} \PY{o}{=} \PY{n}{p}\PY{o}{.}\PY{n}{starmap}\PY{p}{(}\PY{n}{calc\PYZus{}solution\PYZus{}by\PYZus{}parameters}\PY{p}{,} \PY{n}{params}\PY{p}{)}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
[(300, 4.5e+21, 5e-08), (300, 4.5e+21, 1e-07), (300, 4.5e+21, 2e-07), (300,
4.5e+21, 4e-07), (300, 9e+21, 5e-08), (300, 9e+21, 1e-07), (300, 9e+21, 2e-07),
(300, 9e+21, 4e-07), (300, 1.8e+22, 5e-08), (300, 1.8e+22, 1e-07), (300,
1.8e+22, 2e-07), (300, 1.8e+22, 4e-07)]
    \end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
<ipython-input-682-dbc76d7b83ac>:33: RuntimeWarning: divide by zero encountered
in double\_scalars
  percent\_error = res/vdot\_init*100
<ipython-input-682-dbc76d7b83ac>:33: RuntimeWarning: divide by zero encountered
in double\_scalars
...
in double\_scalars
  percent\_error = res/vdot\_init*100
<ipython-input-682-dbc76d7b83ac>:33: RuntimeWarning: invalid value encountered
in double\_scalars
  percent\_error = res/vdot\_init*100
<ipython-input-682-dbc76d7b83ac>:33: RuntimeWarning: invalid value encountered
in double\_scalars
...
in double\_scalars
  percent\_error = res/vdot\_init*100
    ...
    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{685}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
...
\end{tcolorbox}
    ...
    \ldots{} or screen even some more parameters \ldots{}
...
the date have happened.
    ...
    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{843}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
...
'r', 'v', 'v\_dot']]
  ...
  pytables.to\_hdf(path\_or\_buf, key, self, **kwargs)
    ...
    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{893}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
...
\end{tcolorbox}
    ...
    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{877}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
...
\end{tcolorbox}
    ...
    \hypertarget{estimate-correct-solutions-of-incorrectly-found-minima}{%
\subsubsection{Estimate correct solutions of incorrectly found
minima}\label{estimate-correct-solutions-of-incorrectly-found-minima}}

Sometimes the function to minimize the function does not work was
expected. In most cases the searching algorithm does just not find the
minimum of the function and stops after a given number of iterations.
Generally this could be fixed, additional hints are given to the
minimization algorithm. Especially a narrow definition of the region,
where the minimum is to be found is very helpful. To check our solutions
,we could try to represent these solutions and mark the points, where
the minimization result is still too high. Since we have solution for
multiple doping levels (\(N_D\)) and multiple grain radii (\(R\)), I
will represent each combination individually. The Pandas
\texttt{groupby} function allows to split dataframes temporally by group
labels. By grouping the all the results by the label-tuple (\(N_D\),
\(R\)), Pandas will do the work and we can represent the individual
result separetly. since the data halds also a column named \texttt{res}
with the final result from the minimalization, we can distingush godd
and bad results very easy.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{881}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
...
\PY{n}{fig}\PY{p}{,} \PY{n}{axe} \PY{o}{=} \PY{n}{subplots}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{gs}\PY{p}{)}\PY{o}{/}\PY{o}{/}\PY{l+m+mi}{5}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{,} \PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{16}\PY{p}{,}\PY{l+m+mi}{9}\PY{p}{)}\PY{p}{)}
...
\PY{k}{for} \PY{n}{ax\PYZus{}i}\PY{p}{,} \PY{p}{(}\PY{p}{(}\PY{n}{ND}\PY{p}{,}\PY{n}{R}\PY{p}{)}\PY{p}{,} \PY{n}{g}\PY{p}{)} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{gs}\PY{p}{)}\PY{p}{:}
    ...
    \PY{n}{axe}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZob{}ND\PYZcb{}}\PY{l+s+s1}{,}\PY{l+s+si}{\PYZob{}R\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{axe}\PY{o}{.}\PY{n}{set\PYZus{}xlabel}\PY{p}{(}\PY{l+s+sa}{r}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZdl{}E\PYZus{}}\PY{l+s+si}{\PYZob{}Surface\PYZcb{}}\PY{l+s+s1}{\PYZdl{} [\PYZdl{}k\PYZus{}BT\PYZdl{}]}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{fontsize} \PY{o}{=}\PY{l+m+mi}{22}\PY{p}{)}
    \PY{n}{axe}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{l+s+sa}{r}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZdl{}}\PY{l+s+s1}{\PYZbs{}}\PY{l+s+s1}{dot}\PY{l+s+si}{\PYZob{}E\PYZcb{}}\PY{l+s+s1}{\PYZus{}}\PY{l+s+si}{\PYZob{}Surface\PYZcb{}}\PY{l+s+s1}{\PYZdl{} [\PYZdl{}k\PYZus{}BT\PYZdl{}]}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{fontsize} \PY{o}{=}\PY{l+m+mi}{22}\PY{p}{)}
    
\end{Verbatim}
\end{tcolorbox}

    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2-Grain-SMOX_files/2-Grain-SMOX_59_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    The good results can be distinguished well from the bad ones, where the
algorithm failed. Additionally a trained eye is bale to give the
interval, where the correct solution might should lye. As humans can, so
does python. For this problem a simple polynomial fit of the good points
is enough. Once the parameters of the polynom are fitted, a estimation
of the correct solution of the failed points can be calcuated. In the
following plot, this is done. Since we will need the estimation of the
correct value as a stating point for a second minimation, we will add
this value to the Dataframe holding all solutions. Since this function
might become very handy to check the solution, we will wrap it into a
function and reuse it alter.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{894}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{check\PYZus{}solutions}\PY{p}{(}\PY{n}{calc\PYZus{}dF\PYZus{}all}\PY{p}{)}\PY{p}{:}
    \PY{n}{gs} \PY{o}{=} \PY{n}{calc\PYZus{}dF\PYZus{}all}\PY{o}{.}\PY{n}{groupby}\PY{p}{(}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ND}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{R}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
    \PY{n}{fig}\PY{p}{,} \PY{n}{axes} \PY{o}{=} \PY{n}{subplots}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{gs}\PY{p}{)}\PY{o}{/}\PY{o}{/}\PY{l+m+mi}{5}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{,} \PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{16}\PY{p}{,}\PY{l+m+mi}{9}\PY{p}{)}\PY{p}{)}
    ...
    \PY{k}{for} \PY{n}{ax\PYZus{}i}\PY{p}{,} \PY{p}{(}\PY{p}{(}\PY{n}{ND}\PY{p}{,}\PY{n}{R}\PY{p}{)}\PY{p}{,} \PY{n}{g}\PY{p}{)} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{gs}\PY{p}{)}\PY{p}{:}
        ...
        \PY{n}{g\PYZus{}good} \PY{o}{=} \PY{n}{g}\PY{p}{[}\PY{n}{g}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{res}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{\PYZlt{}}\PY{l+m+mi}{2}\PY{p}{]}
        \PY{n}{g\PYZus{}bad} \PY{o}{=} \PY{n}{g}\PY{o}{.}\PY{n}{drop}\PY{p}{(}\PY{n}{g\PYZus{}good}\PY{o}{.}\PY{n}{index}\PY{p}{)}
        \PY{n}{axe}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{g\PYZus{}good}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Einit\PYZus{}kT}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{g\PYZus{}good}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{E\PYZus{}dor\PYZus{}init\PYZus{}kT}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{o\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Good solution}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{axe}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{g\PYZus{}bad}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Einit\PYZus{}kT}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{g\PYZus{}bad}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{E\PYZus{}dor\PYZus{}init\PYZus{}kT}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{o}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Bad solution}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{axe}\PY{o}{.}\PY{n}{set\PYZus{}yscale}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{symlog}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{axe}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZob{}ND\PYZcb{}}\PY{l+s+s1}{,}\PY{l+s+si}{\PYZob{}R\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{axe}\PY{o}{.}\PY{n}{set\PYZus{}xlabel}\PY{p}{(}\PY{l+s+sa}{r}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZdl{}E\PYZus{}}\PY{l+s+si}{\PYZob{}Surface\PYZcb{}}\PY{l+s+s1}{\PYZdl{} [\PYZdl{}k\PYZus{}BT\PYZdl{}]}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{fontsize} \PY{o}{=}\PY{l+m+mi}{22}\PY{p}{)}
        \PY{n}{axe}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{l+s+sa}{r}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZdl{}}\PY{l+s+s1}{\PYZbs{}}\PY{l+s+s1}{dot}\PY{l+s+si}{\PYZob{}E\PYZcb{}}\PY{l+s+s1}{\PYZus{}}\PY{l+s+si}{\PYZob{}Surface\PYZcb{}}\PY{l+s+s1}{\PYZdl{} [\PYZdl{}k\PYZus{}BT\PYZdl{}]}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{fontsize} \PY{o}{=}\PY{l+m+mi}{22}\PY{p}{)}
        ...
        \PY{n}{fit\PYZus{}func} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{poly1d}\PY{p}{(}\PY{n}{g\PYZus{}fit\PYZus{}params}\PY{p}{)}
        \PY{n}{g\PYZus{}bad\PYZus{}correct\PYZus{}y}  \PY{o}{=} \PY{n}{fit\PYZus{}func}\PY{p}{(}\PY{n}{g\PYZus{}bad}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Einit\PYZus{}kT}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
        \PY{n}{axe}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{g\PYZus{}bad}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Einit\PYZus{}kT}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{g\PYZus{}bad\PYZus{}correct\PYZus{}y}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{*k}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{markersize}\PY{o}{=}\PY{l+m+mi}{10}\PY{p}{,} \PY{n}{alpha}\PY{o}{=}\PY{l+m+mf}{0.5}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Estimated solution}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    ...
    \PY{n}{axe} \PY{o}{=} \PY{n}{fig}\PY{o}{.}\PY{n}{axes}\PY{p}{[}\PY{n}{ax\PYZus{}i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{]}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2-Grain-SMOX_files/2-Grain-SMOX_61_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    By using the estimated correct values of the slope at the surface of the
grain, the function \texttt{find\_best\_v\_dot\_init} for the bad
...
rows in the DataFrame which need to be recalculated.
    ...
    \hypertarget{recalculating-the-failed-solutions-with-a-little-help}{%
\subsubsection{Recalculating the failed solutions with a little help
\ldots{}}\label{recalculating-the-failed-solutions-with-a-little-help}}

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{909}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{for} \PY{n}{row\PYZus{}i}\PY{p}{,} \PY{n}{ser\PYZus{}temp} \PY{o+ow}{in} \PY{n}{calc\PYZus{}dF\PYZus{}all}\PY{o}{.}\PY{n}{dropna}\PY{p}{(}\PY{n}{subset}\PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{E\PYZus{}dot\PYZus{}init\PYZus{}kT\PYZus{}estimation}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{iterrows}\PY{p}{(}\PY{p}{)}\PY{p}{:}
    ...
    \PY{c+c1}{\PYZsh{}This is the estimated value from the polynomial fit}
    ...
    \PY{c+c1}{\PYZsh{}Since the correct solution sould be in proximity of this solution, an interval is created from this value (here +\PYZhy{}10\PYZpc{})}
    \PY{n}{bounds} \PY{o}{=} \PY{n+nb}{sorted}\PY{p}{(}\PY{p}{(}\PY{n}{estim}\PY{o}{*}\PY{l+m+mf}{0.9}\PY{p}{,} \PY{n}{estim}\PY{o}{*}\PY{l+m+mf}{1.1}\PY{p}{)}\PY{p}{)}
    
    \PY{c+c1}{\PYZsh{}find the minima again}
    \PY{n}{res} \PY{o}{=} \PY{n}{find\PYZus{}best\PYZus{}v\PYZus{}dot\PYZus{}init}\PY{p}{(}\PY{n}{E\PYZus{}init\PYZus{}kT}\PY{p}{,} \PY{n}{grain}\PY{p}{,}\PY{n}{debug}\PY{o}{=}\PY{k+kc}{False}\PY{p}{,} \PY{n}{bounds}\PY{o}{=}\PY{n}{bounds}\PY{p}{)}
    
    \PY{c+c1}{\PYZsh{}save the relevant paramters}
    \PY{n}{ser\PYZus{}temp}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{E\PYZus{}dor\PYZus{}init\PYZus{}kT}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{n}{res}\PY{o}{.}\PY{n}{x}
    \PY{n}{ser\PYZus{}temp}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{res}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{n}{res}\PY{o}{.}\PY{n}{fun}

    \PY{n}{r}\PY{p}{,}\PY{n}{v}\PY{p}{,}\PY{n}{vdot}\PY{p}{,} \PY{n}{data} \PY{o}{=} \PY{n}{grain}\PY{o}{.}\PY{n}{solve\PYZus{}with\PYZus{}values}\PY{p}{(}\PY{n}{grain}\PY{o}{.}\PY{n}{material}\PY{o}{.}\PY{n}{kT\PYZus{}to\PYZus{}J}\PY{p}{(}\PY{n}{E\PYZus{}init\PYZus{}kT}\PY{p}{)}\PY{p}{,}\PY{n}{grain}\PY{o}{.}\PY{n}{material}\PY{o}{.}\PY{n}{kT\PYZus{}to\PYZus{}J}\PY{p}{(}\PY{n}{res}\PY{o}{.}\PY{n}{x}\PY{p}{)}\PY{p}{,} \PY{p}{)}
    ...
    \PY{c+c1}{\PYZsh{}overwrite the existing solution with the optimized on.}
    \PY{n}{calc\PYZus{}dF\PYZus{}all}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{n}{ser\PYZus{}temp}\PY{o}{.}\PY{n}{name}\PY{p}{]} \PY{o}{=} \PY{n}{ser\PYZus{}temp}
...
\end{tcolorbox}
    ...
    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{910}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nb}{len}\PY{p}{(}\PY{n}{calc\PYZus{}dF\PYZus{}all}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

            \begin{tcolorbox}[breakable, size=fbox, boxrule=.5pt, pad at break*=1mm, opacityfill=0]
\prompt{Out}{outcolor}{910}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
252
\end{Verbatim}
\end{tcolorbox}
        
    \hypertarget{checking-the-solutions}{%
\subsubsection{Checking the solutions}\label{checking-the-solutions}}

    Now the solution should all be available and a simple representation
should reveal some insight about its quality.

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{903}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
The maximal "error" of the minimization is :0.5170560064489109
    \end{Verbatim}

    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2-Grain-SMOX_files/2-Grain-SMOX_68_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
grain}\label{shape-of-the-potential-drop-inside-the-grain}}
    ...
    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{907}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{for} \PY{n}{ND}\PY{p}{,} \PY{n}{calc\PYZus{}dF} \PY{o+ow}{in} \PY{n}{calc\PYZus{}dF\PYZus{}all}\PY{o}{.}\PY{n}{groupby}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ND}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{:}
    \PY{n}{fig}\PY{p}{,} \PY{n}{axes}\PY{o}{=} \PY{n}{subplots}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{n}{figsize} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{16}\PY{p}{,}\PY{l+m+mi}{9}\PY{p}{)}\PY{p}{,} \PY{n}{sharex}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}
    ...
    \PY{c+c1}{\PYZsh{}fig.suptitle(f\PYZsq{}\PYZdl{}\PYZbs{}\PYZbs{}num\PYZob{}\PYZob{}\PYZob{}2e\PYZhy{}10\PYZcb{}\PYZcb{}\PYZcb{}\PYZdl{}\PYZsq{}, fontsize = 22)}
    ...
    \PY{k}{for} \PY{n}{ax\PYZus{}i}\PY{p}{,} \PY{p}{(}\PY{n}{R}\PY{p}{,} \PY{n}{calc\PYZus{}dF\PYZus{}grainsize}\PY{p}{)} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{calc\PYZus{}dF}\PY{o}{.}\PY{n}{groupby}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{R}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}\PY{p}{:}
        ...
        \PY{n}{axe}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{p}{)}
        \PY{n}{axe}\PY{o}{.}\PY{n}{grid}\PY{p}{(}\PY{n}{b}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
        \PY{c+c1}{\PYZsh{}axe.set\PYZus{}xlim(0,40)}
    \PY{n}{fig}\PY{o}{.}\PY{n}{tight\PYZus{}layout}\PY{p}{(}\PY{p}{)}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2-Grain-SMOX_files/2-Grain-SMOX_70_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2-Grain-SMOX_files/2-Grain-SMOX_70_2.png}
    \end{center}
    { \hspace*{\fill} \\}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2-Grain-SMOX_files/2-Grain-SMOX_70_4.png}
    \end{center}
    { \hspace*{\fill} \\}
